<div>
    <div
        ...
        <div class="search-global" style="width:300px">
            ...
            <input type="text" wire:model.live.debounce.300ms="buscar" placeholder="Buscar tipo de existencia...">
        </div>
        ...
        <table>
            ...
            <tbody>
                @forelse ($tipos as $tipo)
                    <tr>
                        <td><span class="badge badge-neutral" style="font-family:monospace">{{ $tipo->codigo_sunat }}</span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align:center;padding:60px;color:var(--text-muted)">
                            <i data-lucide="layers" style="width:48px;height:48px;display:block;margin:0 auto 12px"></i>
                            No se encontraron tipos de existencia
                        </td>
                    </tr>
                @endforelse
            </tbody>
        ...
        <div class="modal-backdrop" wire:click.self="$set('showModal', false)">
            <div class="modal" style="max-width:480px">
                <div class="modal-header">
                    <h3 style="font-weight:700">{{ $editMode ? 'Editar Tipo Existencia' : 'Nuevo Tipo Existencia' }}</h3>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model="codigo_sunat" class="form-input" placeholder="Ej: 01, 02">
                        @error('codigo_sunat') <span style="color:var(--danger);font-size:0.75rem">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Descripción *</label>
                        <input type="text" wire:model="descripcion" class="form-input" placeholder="Ej: Mercadería">
